...
use Zahzah\ModuleWarehouse\Resources\StockBatch\ViewStockBatch;

class StockBatch extends MainStock{
    protected $list = [
        'id','parent_id','stock_id','batch_id','stock'
    ];
    ...
    //EIGER SECTION
    public function stockModel(){return $this->belongsToModel('Stock');}
